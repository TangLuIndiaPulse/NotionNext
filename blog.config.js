...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '02ab3b8678004aa69e9e415905ef32a5,en:1e90796c7a688080ac8fc9aa24fa37a6',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'TANGLU', // 您的昵称 例如 tang_laxmi
  BIO: process.env.NEXT_PUBLIC_BIO || '印度爱好者🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://hellotanglu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'India Pulse, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个写字员, Hi，我是一个清洁工,Hi，我是一个干饭人,欢迎来到我的博客🎉',
